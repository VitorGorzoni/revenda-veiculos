...
class VeiculoControllerTest {
    ...
    @MockBean
    private ListarVeiculosPorStatusService listarVeiculosPorStatusService;
    ...
    void deveCadastrarVeiculoComSucesso() throws Exception {
        ...
        when(cadastrarVeiculoService.execute(any(Veiculo.class))).thenReturn(veiculoSalvo);
    ...
    void deveListarVeiculosComSucesso() throws Exception {
        ...
        when(listarTodosVeiculosService.execute()).thenReturn(veiculos);
